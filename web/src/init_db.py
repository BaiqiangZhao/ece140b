...
values = [
  ('','Cameron Nazemi','cnazemi@ucsd.edu', 'abc123', '2020-02-20 12:00:00'),
  ('','Daniel Kubeck','dkubeck@ucsd.edu', 'abc123', '2020-02-20 12:00:00'),
  ('','Baiqiang Zhao','b3zhao@ucsd.edu','abc123','2020-02-20 12:00:00')
